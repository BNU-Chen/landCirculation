 ...
 * @see cn.ac.irsa.landcirculation.UserRole
...
public class UserRoleHome {
	...
	public UserRole findById(java.lang.Integer id) {
		...
		try {
			UserRole instance = (UserRole) sessionFactory.getCurrentSession().get("cn.ac.irsa.landcirculation.UserRole", id);
			if (instance == null) {
	...
	public List findByExample(UserRole instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.ac.irsa.landcirculation.UserRole").add(Example.create(instance)).list();
