...
/**
 * Home object for domain model class Apply.
 * @see cn.ac.irsa.landcirculation.Apply
 * @author Hibernate Tools
 */
public class ApplyHome {

	private static final Log		log				= LogFactory.getLog(ApplyHome.class);
	...
	public void persist(Apply transientInstance) {
		log.debug("persisting Apply instance");
		try {
	...
	public Apply merge(Apply detachedInstance) {
		...
		try {
			Apply result = (Apply) sessionFactory.getCurrentSession().merge(detachedInstance);
	...
	public Apply findById(java.lang.Integer id) {
		...
		try {
			Apply instance = (Apply) sessionFactory.getCurrentSession().get("cn.ac.irsa.landcirculation.Apply", id);
			if (instance == null) {
	...
	public List findByExample(Apply instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("cn.ac.irsa.landcirculation.Apply").add(Example.create(instance)).list();
