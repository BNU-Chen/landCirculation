					...
					<table width="100%" border="0" cellpadding="0" cellspacing="0">
						...
						<tr>
							...
							<td><span id="spryselect1"> <select
									name="circulationDemand.landProvince" id="province"
									onchange="send_cityRequest();">
										<option value="-1">--请选择--</option>
								</select>
							</span> <br /> 省（自治区、直辖市）</td>
							<td><span id="spryselect2"> <select
									name="circulationDemand.landCity" id="city"
									onchange="send_countyRequest();">
										<option value="-1">--请选择--</option>
								</select>
							</span><br />市（地区、自治州、盟）</td>
							<td><span id="spryselect3"> <select
									name="circulationDemand.landCounty" id="county"
									onchange="send_townRequest();">
										<option value="-1">--请选择--</option>
								</select>
							</span><br />县（区、旗）</td>
							<td><span id="spryselect4"> <select
									name="circulationDemand.landTown" id="town"
									onchange="send_villageRequest();">
										<option value="-1">--请选择--</option>
								</select>
							</span><br />乡（镇、街道）</td>
							<td><span id="spryselect5"> <select
									name="circulationDemand.landVillage" id="village">
										<option value="-1">--请选择--</option>
								</select>
							</span><br />村（居居委会）</td>
						</tr>
						<tr>
							...
							<td><input name="circulationDemand.landTeam" type="text"
								...
								value="${circulationDemand.landTeam}" /></td>
							<td><label><b>流转形式</b></label></td>
							<td><span id="spryselect6"> <select
									name="circulationDemand.CirculationType" id="circulationType"><s:if
							...
							<td><span id="sprytextfield1"> <input
									...
									size="2" maxlength="2"
									value="${circulationDemand.landDuration}" /> <span
						...
						<tr>
							...
							<td><span id="spryselect7"> <select
									name="circulationDemand.landType" id="select2">
										<s:if
							...
							<td><span id="sprytextfield2"> <input
									...
									size="4" maxlength="4" value="${circulationDemand.landArea}" />
							...
							<td><span id="sprytextfield3"> <input
									...
									size="6" maxlength="6" value="${circulationDemand.landPrice}" />
									<span class="textfieldRequiredMsg">需要提供一个值。</span><span
									class="textfieldInvalidFormatMsg">格式无效。</span><span
									class="textfieldMinValueMsg">输入值小于所需的最小值。</span></span></td>
						</tr>
						<tr>
							...
							<td colspan="5"><span id="sprytextfield4"> <input
									...
									value="${circulationDemand.landUseType}" /> <span
						...
						<tr>
							...
							<td><span id="sprytextfield5"> <input type="text"
									...
									value="${circulationDemand.picName}" /> <span
									class="textfieldRequiredMsg">必填。</span><span
							...
							<td><span id="sprytextfield6"> <input type="text"
									...
									value="${circulationDemand.picIdcode}" /> <span
									class="textfieldRequiredMsg">必填。</span><span
							...
							<td><span id="sprytextfield7"> <input type="text"
									...
									value="${circulationDemand.picTel}" /> <span
									class="textfieldRequiredMsg">必填。</span><span
						...
						<tr>
							...
							<td colspan="3"><span id="sprytextfield8"> <input
									...
									size="80" value="${circulationDemand.picAddress}" /> <span
									class="textfieldRequiredMsg">需要提供一个值。</span><span
									class="textfieldMinCharsMsg">不符合最小字符数要求。</span><span
									class="textfieldMaxCharsMsg">已超过最大字符数。</span></span></td>
							<td><label><b>电子邮件</b></label></td>
							<td><span id="sprytextfield9"> <input type="text"
									...
									value="${circulationDemand.picEmail}" /> <span
									class="textfieldRequiredMsg">必填。</span><span
									class="textfieldMaxCharsMsg">已超过最大字符数。</span></span></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="5"><span id="sprytextarea1"> <textarea
									...
									id="textarea1"><s:property
											value="#circulationDemand.demanderDescript" /></textarea> <span
						...
						<tr>
							...
							<td colspan="5"><span id="sprytextarea2"> <textarea
									...
									cols="55" rows="5"><s:property
											value="#circulationDemand.projectDescript" /></textarea> <span
