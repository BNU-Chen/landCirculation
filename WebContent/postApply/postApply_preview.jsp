...
<script language="javascript">
	...
	function print() {
		var postApplyid = document.getElementById("postApplyid").value;
		url = "PostApply!printPostApply?postApply.id=" + postApplyid;
		alert(url);
		window
				.open(
						url,
...
<body onload="pagesetup_report();">
	<center class="NOPRINT">
		...
		<input id="postApplyid" type=hidden value="${postApply.id}" />
		<%--<input
