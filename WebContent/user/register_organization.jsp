...
<script type="text/javascript">
	function submitForm() {
		document.getElementById("btRegist2").click();
	}
</script>
<style type="text/css">
#wrap {
			...
			<div id="client">
				<form id="user/userRegister" name="userRegister" method="post"
					...
					<table border="0" cellpadding="0" cellspacing="0" width="100%">
						<tr class="hide">
							<td>用户性质</td>
							<td><input type="text" name="userPerson.userType" value="02"></td>
						</tr>
						<tr class="hide">
							<td>证件类型</td>
						...
						<tr>
							...
							<td><span id="userPerson_userId"> <input
									...
									class="textfieldMaxCharsMsg">8位组织机构代码，不足8位。</span></span></td>
						</tr>
						<tr>
							<td><label for="userPerson.userName">单位名称</label></td>
							<td><span id="userPerson_userName"> <input
									name="userPerson.userName" type="text" id="userPerson.userName"
									size="20" /> <span class="textfieldRequiredMsg">组织机构代码证单位名称。</span><span
						...
						<tr>
							<td></td>
							<td><input type="submit" id="btRegist2" value="注    册" /> <input
