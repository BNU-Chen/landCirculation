	...
	<div id="menu">
		...
		<div id="menuitem7" class="menuitem hide">
			<ul>
				...
				<li><a href="#">交易态势分析</a></li>
				<li><a href="#">土地用途监察</a></li>
				<li><a
					href="../supervision/Conpensation!listtoconpensateContract"
					target="contentTarget">流出方经济补偿跟踪</a></li>
		...
		<div id="menuitem8" class="menuitem hide">
			<ul>
				...
				<li><a href="../admin/test.jsp" target="contentTarget">测试</a></li>
			</ul>
		</div>
	</div>
</body>
