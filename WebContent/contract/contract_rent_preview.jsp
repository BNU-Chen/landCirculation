...
<body onload="pagesetup_report();">
	<center class="NOPRINT">
		...
		<input type=button value="浏览器打印 " onclick="autoprint();" /> <input
			type=button value="返回" onclick="window.close();" />
	</center>
	...
	<div class="A4">
		<div class="A4content">
			...
			<table class="tablenoborder" border="0" cellspacing="0"
				...
				<tr>
					<td><table width="754" border="0" cellpadding="0"
							...
							<tr>
								...
								<td width="72"><div class="tdbottom1">
										<s:property value="contractBase.landCountyName" />
									</div></td>
								<td width="48"><div class="title5">县(区)</div></td>
								<td width="80"><div class="tdbottom1">
										<s:property value="contractBase.landTownName" />
									</div></td>
								<td width="60"><div class="title5">乡(镇)</div></td>
								<td width="10"></td>
								<td width="80"><div class="title5">合同编号：</div></td>
								<td width="160"><div class="tdbottom1">
										<s:property value="contractBase.contractNo" />
									</div></td>
								<td width="60"></td>
							</tr>
						</table></td>
				...
				<tr>
					<td height="40" class="title0"><s:property
							value="contractBase.landProvinceName" />农村土地承包经营权出租合同</td>
				</tr>
				<tr>
					<td height="280"></td>
				</tr>
				...
				<tr>
					<td><table class="tablenoborder" border="0" cellspacing="0"
							...
							<tr>
								...
								<td width="231"><div class="title4">
										<s:property value="contractBase.landProvinceName" />农业委员会
									</div></td>
							...
							<tr height="40">
								<td height="20"></td>
								<td><div class="title4">
										<s:property value="contractBase.landProvinceName" />工商行政管理局
									</div></td>
								<td></td>
							</tr>
						</table></td>
				...
				<tr>
					...
					<td width="634" height="960">
						<table class="tablenoborder" border="0" cellpadding="0"
							...
							<tr>
								<td colspan="8" height="40"><div class="title1">
										<s:property value="contractBase.landProvinceName" />
										农村土地承包经营权出租合同
									</div></td>
							</tr>
							...
							<tr>
								<td colspan="8">
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractBase.landAddressName" />
											】
										</div>
										<!-- 										区（县） -->
										...
										<div class="content">
											【
											<s:property value="#contractBase.landRgArea" />
											】
										</div>
										...
										<tr>
											<td><table class="tableborder1" width="100%" border="0"
													...
													<tr>
														...
														<td rowspan="2" class="tdtop0">是否基本农田</td>
													</tr>
													<tr>
													...
													<s:iterator var="parcel" value="#parcels" status="st">
														<tr>
															...
															<td><s:if test="#parcel.basicFarmland==1"> 高标准基本农田 </s:if>
																...
																<s:elseif test="#parcel.basicFarmland==2"> 非基本农田 </s:elseif></td>
														</tr>
													</s:iterator>
					...
					承包经营合同
														...
														<td><b>编号</b></td>
														<td colspan="5" align="left"><div class="content">
																<s:if test="#contractBase.rightAuthType==1">
					权证:<s:property value="#contractBase.landWarrantCode" />
																</s:if>
																<s:else>
					合同：<s:property value="#contractBase.landContractCode" />
																</s:else>
															</div></td>
													...
													<tr>
														...
														<td width="120">亩，<b>其中水田：</b></td>
														<td width="60"><div class="content">
																<s:property value="#contractBase.paddyfieldRgArea" />
															</div></td>
														<td width="160">亩，<b>旱地：</b></td>
														<td width="60"><div class="content">
																<s:property value="#contractBase.drylandRgArea" />
															</div></td>
														<td width="120">亩；<b>地块数：</b></td>
														<td><div class="content">
																<s:property value="#contractBase.landNumber" />
															</div></td>
														<td>块</td>
													</tr>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="contractBase.duration" />
											】
										</div>
										年，自
										<div class="content">
											【
											<s:date name="#contractBase.fromDate" format="yyyy" />
											】
										</div>
										年
										<div class="content">
											【
											<s:date name="#contractBase.fromDate" format="M" />
											】
										</div>
										月
										<div class="content">
											【
											<s:date name="#contractBase.fromDate" format="d" />
											】
										</div>
										日起至
										<div class="content">
											【
											<s:date name="#contractBase.toDate" format="yyyy" />
											】
										</div>
										年
										<div class="content">
											【
											<s:date name="#contractBase.toDate" format="M" />
											】
										</div>
										月
										<div class="content">
											【
											<s:date name="#contractBase.toDate" format="d" />
											】
										</div>
										日止（不得超过土地承包期的剩余期限）。
									</div>
	...
	<div class="A4">
		...
		<table class="tablenoborder" cellpadding="0" cellspacing="0">
			<tr>
				<td width="40"></td>
				<td width="634" height="960"><table class="tablenoborder"
						...
						<tr>
							<td>
								...
								<div class="term">
									...
									<s:if test="#contractRent.areaType=1">
										<div class="content">☑</div>
										登记面积计算；
									<div class="content">☒</div>
									实际面积计算。</s:if>
								...
								<div class="term">
									...
									<div class="content">
										【
										<s:property value="#contractRent.payType" />
										】
									</div>
									种方式支付出租价款：
								</div> <s:if test="#contractRent.payType==1">
									<div class="term">
										①货币支付：第一年出租价款为按水田每亩人民币
										<div class="content">
											【
											<s:property value="#contractRent.payType11" />
											】
										</div>
										元，按旱地每亩人民币
										<div class="content">
											【
											<s:property value="#contractRent.payType12" />
											】
										</div>
										元，合计人民币
										<div class="content">
											【
											<s:property value="#contractRent.payType13" />
											】
										</div>
										元(大写：
										<div class="content">
											【
											<s:property value="#contractRent.payType13string" />
											】
										</div>
										) ，以后递增方式为每年
										<div class="content">
											【
											<s:property value="#contractRent.payType14" />
											】
										</div>
										% 。
									</div>
								...
								</s:if> <s:if test="#contractRent.payType==2">
									<div class="term">
										①货币支付：第一年出租价款为按水田每亩人民币
										<div class="content">【####】</div>
										元，按旱地每亩人民币
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.payType21" />
											】
										</div>
										斤，合计
										<div class="content">
											【
											<s:property value="#contractRent.payType23" />
											】
										</div>
										斤
										<div class="content">
											【
											<s:property value="#contractRent.payType22name" />
											】
										</div>
										(填黄谷、玉米或双方议定的其他实物），按旱地每亩
										<div class="content">
											【
											<s:property value="#contractRent.payType24" />
											】
										</div>
										斤，合计
										<div class="content">
											【
											<s:property value="#contractRent.payType26" />
											】
										</div>
										斤
										<div class="content">
											【
											<s:property value="#contractRent.payType25name" />
											】
										</div>
										(填黄谷、玉米或双方议定的其他实物），以后递增方式为每年
										<div class="content">
											【
											<s:property value="#contractRent.payType27" />
											】
										</div>
										% 。
									</div>
								...
								</s:if> <s:if test="#contractRent.payType==3">
									<div class="term">
										①货币支付：第一年出租价款为按水田每亩人民币
										<div class="content">【####】</div>
										元，按旱地每亩人民币
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.payType31" />
											】
										</div>
								...
								<div class="term">
									...
									<div class="content">
										【
										<s:property value="#contractRent.paytimeType" />
										】
									</div>
									种方式支付出租价款:
								</div> <s:if test="#contractRent.paytimeType==1">
									<div class="term">
										1.提前1年支付：本合同生效后
										<div class="content">
											【
											<s:property value="#contractRent.paytimeType11" />
											】
										</div>
										天内，乙方向甲方一次性支付第一年度的出租价款；以后每年
										<div class="content">
											【
											<s:property value="#contractRent.paytimeType12" />
											】
										</div>
										月
										<div class="content">
											【
											<s:property value="#contractRent.paytimeType13" />
											】
										</div>
										日前，乙方向甲方支付下一年度的出租价款。
									</div>
								...
								</s:if> <s:if test="#contractRent.paytimeType==2">
									<div class="term">
										1.提前1年支付：本合同生效后
										<div class="content">【####】</div>
										天内，乙方向甲方一次性支付第一年度的出租价款；以后每年
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.paytimeType21" />
											】
										</div>
										天内，乙方向甲方一次性支付第一年度的出租价款；以后每年
										<div class="content">
											【
											<s:property value="#contractRent.paytimeType22" />
											】
										</div>
										月
										<div class="content">
											【
											<s:property value="#contractRent.paytimeType23" />
											】
										</div>
										日前，乙方向甲方支付当年度的出租价款。
									</div>
								...
								</s:if> <s:if test="#contractRent.paytimeType==3">
									<div class="term">
										1.提前1年支付：本合同生效后
										<div class="content">【####】</div>
										天内，乙方向甲方一次性支付第一年度的出租价款；以后每年
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:date name="contractBase.paytimeType31" format="yyyy" />
											】
										</div>
										年
										<div class="content">
											【
											<s:date name="contractBase.paytimeType31" format="M" />
											】
										</div>
										月
										<div class="content">
											【
											<s:date name="contractBase.paytimeType31" format="d" />
											】
										</div>
										日前，乙方向甲方一次性支付全部出租价款。
									</div>
								...
								</s:if> <s:if test="#contractRent.paytimeType==4">
									<div class="term">
										1.提前1年支付：本合同生效后
										<div class="content">【####】</div>
										天内，乙方向甲方一次性支付第一年度的出租价款；以后每年
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="contractBase.paytimeType41" />
											】
										</div>
								...
								<div class="term">
									...
									<div class="content">
										【
										<s:property value="#contractRent.compensation" />
										】
									</div>
								...
								<div class="term">
									...
									<div class="content">
										【
										<s:property value="#contractRent.landtransferType" />
										】
									</div>
									）项方式将出租土地交付给乙方：
								</div>
								<div class="term">①一次性全部交付。</div> <s:if
									test="#contractRent.landtransferType==1">
									<div class="term">
										②
										<div class="content">【########】</div>
									...
									<s:else>
										<div class="term">
											...
											<div class="content">
												【
												<s:property value="#contractRent.landtransferType21" />
												】
											</div>
							...
							<tr>
								<td>
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.landtransferOtherDatum" />
											】
										</div>
										 
									</div>
									<div class="term">
										 3.交付时间为：
										<div class="content">
											<s:date name="#contractRent.landtransferDate" format="【yyyy】" />
											年
											<s:date name="#contractRent.landtransferDate" format="【M】" />
											月
											<s:date name="#contractRent.landtransferDate" format="【d】" />
											日
										</div>

									</div>
									<div class="titleleft3">七、甲方的权利和义务</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.transferOtherRight" />
											】
										</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.transfeeOtherRight" />
											】
										</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.endcirculationDisposal" />
											】
										</div>
									</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractModify" />
											】
										</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach11" />
											】
										</div>
										%承担违约金；超过
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach12" />
											】
										</div>
					...
					<td width="634" height="960"><table class="tablenoborder"
							...
							<tr>
								<td><div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach21" />
											】
										</div>
										%承担违约金；超过
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach22" />
											】
										</div>
										 天仍未交付的，乙方有权解除合同。
									</div>
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach31" />
											】
										</div>
										元违约金。
									</div>
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach41" />
											】
										</div>
										元违约金。
									</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach71" />
											】
										</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.contractBreach81" />
											】
										</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.other11" />
											】
										</div>
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.other21" />
											】
										</div>
									...
									<div class="term">
										...
										<s:if test="#contractRent.authentication==1">
											<div class="content">☑</div>
										申请合同鉴证；
										<div class="content">☒</div>
										不申请合同鉴证。
									...
									<div class="term">
										...
										<div class="content">
											【
											<s:property value="#contractRent.other51" />
											】
										</div>

									</div>
									<div class="term">
										6.本合同一式四份，双方各执一份，发包方和镇（乡）人民政府农村土地承包管理部门各备案一份（如有鉴证，相应增加一份）。</div></td>
							</tr>
							<tr>
								<td height="10"></td>
							</tr>
							<tr>
								<td><table class="tablenoborder" cellpadding="0"
										cellspacing="0">
										<tr>
											<td rowspan="2" width="50%"><div class="titleleft4">
													甲方（签章）：
													<s:property value="contractBase.transferName" />
												</div></td>
										...
										<tr>
											<td height="30"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transfeePicName" />
														】
													</div>
												</div></td>
										</tr>
										<tr>
											<td width="50%"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transferIdcode" />
														】
													</div>
												</div></td>
											<td height="30"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transferPicIdcode" />
														】
													</div>
												</div></td>
										</tr>
										<tr>
											<td width="50%"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transferAddress" />
														】
													</div>
												</div></td>
											<td height="30"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transfeeAddress" />
														】
													</div>
												</div></td>
										</tr>
										<tr>
											<td width="50%"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transferTel" />
														】
													</div>
												</div></td>
											<td height="30"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transfeeTel" />
														】
													</div>
												</div></td>
										</tr>
										<tr>
											<td width="50%"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transferAgentName" />
														】
													</div>
												</div></td>
											<td height="30"><div class="titleleft4">
													...
													<div class="content">
														【
														<s:property value="contractBase.transfeeAgentName" />
														】
													</div>
												</div></td>
										</tr>
