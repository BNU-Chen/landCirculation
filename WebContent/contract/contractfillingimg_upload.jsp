		...
		<div id="wrap">
			...
			<div id="client">
				...
				<div>
					...
					<%-- 					<sx:submit type="submit" href="ContractfillingimgUpload!uploadContractfillingimg" formId="formContractImg" label="上传扫描件" /> --%>
					<sx:div id="divImglist">
						<s:url var="urlListContractfillingimg"
							action="ContractfillingimgUpload!listContractfillingimg">
							<s:param name="contractfilling.id" value="#contractfilling.id" />
						</s:url>
						<%-- 						<sx:div id="divContractfillingimgslist" --%>
						<%-- 							href="%{urlListContractfillingimg}" executeScripts="true" /> --%>
					</sx:div>
				</div>
			</div>
		</div>
