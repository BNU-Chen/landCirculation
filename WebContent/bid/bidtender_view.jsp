			...
			<div id="client">
				<table width="100%" border="0" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td colspan="5"><s:property value="#bidtender.enrollNo" /></td>
					</tr>
								...
								<table width="100%" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										...
										<td width="320"><span id="sprytextfield1"> <input
												...
												disabled> <span class="textfieldMaxCharsMsg">最多7位数字</span><span
					...
					<tr>
						...
						<td><a href="./${bidtender.tenderFilePathname}">下载</a></td>
					</tr>
