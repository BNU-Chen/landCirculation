		...
		<div id="wrap">
			<div id="client">
				<form id="form1" name="form1" method="post"
					action="BidOpen!saveBidtenderReview" target="_parent">
					<table width="100%">
						<tr class="hide">
							<td>bidtenderId</td>
							<td><input type="text" name="bidtender.id" value="${bidtender.id}" /></td>
						</tr>
						<tr>
							<td><label>总体结论</label></td>
							<td><input name="bidtender.reviewResult" type="radio"
								<s:if test="#bidtender.reviewResult==0"> checked="CHECKED"</s:if>
								id="reviewResult_0"
								onclick="document.getElementById('reviewComment').value='';document.getElementById('reviewComment').disabled='disabled';"
								value="0" />通过<input name="bidtender.reviewResult"
								type="radio"
								<s:if test="#bidtender.reviewResult==1"> checked="CHECKED" </s:if>
								id="reviewResult_1"
						...
						<tr>
							...
							<td><span id="spryAdvice"> <textarea
									name="bidtender.reviewComment" id="reviewComment" rows="10"
									<s:if test="#bidtender.reviewResult==0"> disabled="disabled"</s:if>><s:property
											value="#bidtender.reviewComment" /></textarea> <span
