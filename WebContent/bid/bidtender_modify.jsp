			...
			<div id="toc">
				<table border="0" align="left" cellpadding="0" cellspacing="0">
					<tr>
						...
						<td><label onclick="showTabpane(1)">竞标书</label></td>
					</tr>
				</table>
			</div>
			<div id="client">
				...
				<div id="bidtendeupdate" class="panel">
					<s:url action="BidTender!updateBidtender"
						var="urlupdateBidtender">
						<s:param name="bidtender.id" value="#bidtender.id" />
					</s:url>

					<iframe src="${urlupdateBidtender}" class="iframepanel"
