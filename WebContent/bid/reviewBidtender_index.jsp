...
<body>
	<div id="webClient">
		<div id="wrap">
			<div id="title">
				<label>电子交易--竟标书形式审查</label>
			</div>
			<div id="toc">
				<table border="0" align="left" cellpadding="0" cellspacing="0">
					<tr>
						<td><label id="default" onclick="showTabpane(0)">查看招标公告</label></td>
						<td><label class="selected" onclick="showTabpane(1)">查看竞标书材料</label></td>
						<td><label onclick="showTabpane(2)">竞标书形式审查</label></td>
					</tr>
				</table>
			</div>
			<div id="client">
				<div id="bidpostInfo" class="panel hide">
					<s:url action="../bid/BidPost!previewBidpost" var="urlViewBidpost">
						<s:param name="bidpost.id" value="#bidtender.bidpost.id" />
					</s:url>
					<iframe src="${urlViewBidpost}" class="iframepanel" frameborder="0"
						width="100%" height="2000" scrolling="no"></iframe>
				</div>
				<div id="bidtenderInfo" class="panel">
					<s:url action="BidTender!viewBidtender" var="urlviewBidtenderInfo">
						<s:param name="bidtender.id" value="#bidtender.id" />
					</s:url>

					<iframe src="${urlviewBidtenderInfo}" class="iframepanel"
						frameborder="0" width="100%" height="1000" scrolling="no"></iframe>
				</div>
				<div id="bidtenderReview" class="panel hide">
					<s:url action="BidOpen!updateBidtenderReview"
						var="urlReviewBidtender">
						<s:param name="bidtender.id" value="#bidtender.id" />
					</s:url>

					<iframe src="${urlReviewBidtender}" class="iframepanel"
						frameborder="0" width="100%" height="1000" scrolling="no"></iframe>
				</div>
			</div>
		</div>
