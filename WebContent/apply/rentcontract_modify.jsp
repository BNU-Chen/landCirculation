...
<body>
	<div id="webClient">
		<div id="wrap">
			<div id="title"></div>
			<div id="client">
				<form id="form3" name="form3" method="post" action="Rentcontract!saveRentcontract">
					<table border="0" cellspacing="0" cellpadding="0" id="tabContract"
						width="100%">
						<tr class="hide">
							<td></td>
							<td><input id="ApplyID" name="apply.id" type="hidden"
								value="${Apply.id}" /></td>
						</tr>
						<tr>
							<td width="200"></td>
						...
						<s:if test="#rentcontract.payType==3">
							<tr class="paystyle">
								...
								<td><span id="sprytextarea11"> <textarea class="2"
										name="rentcontract.payType31" id="textarea11" rows="5"><s:property
												value="#rentcontract.payType31" /></textarea> <span
						...
						<s:if test="#rentcontract.paytimeType==4">
							<tr class="paytime ">
								...
								<td>其它：<span id="sprytextarea51"> <textarea
										...
										rows="8"><s:property
												value="#rentcontract.paytimeType41" /></textarea> <span
						...
						<tr>
							...
							<td>甲方在出租前对该土地投入而提高土地生产能力，以及在该土地上的青苗、构（附）着物等，双方约定补偿标准、方式及时间为：
								<span id="sprytextarea2"> <textarea
									name="rentcontract.compensation" id="textarea2" rows="8"><s:property
											value="#rentcontract.compensation" /></textarea> <span
							...
							<tr class="landtransfer">
								...
								<td>交付约定：<span id="sprytextarea13"> <textarea
										...
										id="textarea13" rows="8"><s:property
												value="#rentcontract.landtransferType21" /></textarea> <span
						...
						<tr>
							...
							<td>2.交付资料：  <br /> ①土地承包经营权证或承包合同复印件（含红线图）； <br />
								...
								id="sprytextarea14"> <textarea
									...
									rows="8"><s:property
											value="#rentcontract.landtransferOtherDatum" /></textarea><span
						...
						<tr>
							...
							<td>1.依法获得土地承包经营权出租的收益。 <br /> 2.依法或按照合同约定收回出租的土地承包经营权。 <br />
								...
								id="sprytextarea3"> <textarea
									...
									rows="8"><s:property
											value="#rentcontract.transferorOtherRight" /></textarea></span></td>
						</tr>
						<tr>
							...
							<td>1.依法享有承租土地的使用权、收益权、自主生产经营权。<br />2.合同期内，改变合同约定主营项目，需经得甲方书面同意。<br />3.依法保护和合理利用土地，不得给土地造成永久性损害。 <br />4.合同期内，对土地进行再流转，需经得甲方书面同意。 <br />5.合同期满后，及时向甲方交还承租的土地承包经营权。  <br />6.其它：<span
								id="sprytextarea4"> <textarea
									...
									rows="8"><s:property
											value="#rentcontract.transfereeOtherRight" /></textarea> <span
						...
						<tr>
							...
							<td>合同期满后，甲方收回该土地承包经营权。乙方对该土地进行投入而提高土地生产能力的、在当时为生产经营需要而设立的相关设施及地上构(附)着物等，双方约定处理方式、时间为：<br />
								<span id="sprytextarea5"> <textarea
									...
									rows="8"><s:property
											value="#rentcontract.endcirculationDisposal" /></textarea> <span
						...
						<tr>
							...
							<td>1.经双方协商一致，可变更或解除本合同。 <br />
								...
								4.其它：<span id="sprytextarea6"> <textarea
									name="rentcontract.contractModify" rows="8" id="textarea6"><s:property
											value="#rentcontract.contractModify" /></textarea> <span
						...
						<tr>
							...
							<td>1.乙方不按期支付出租价款的，每延迟壹天，按应付费用的<span id="sprytextfield21">
								...
								id="sprytextarea7"> <textarea
									...
									rows="8"><s:property
											value="#rentcontract.contractBreach81" /></textarea> <span
						...
						<tr>
							...
							<td>1.合同期内，该土地涉及的国家有关政策性补贴、补助及其他费用等权利按如下方式处理：<br /> <span
								id="sprytextarea8"> <textarea name="rentcontract.other11"
									id="textarea8" rows="8"><s:property
											value="#rentcontract.other11" /></textarea> <span
								...
								id="sprytextarea9"> <textarea name="rentcontract.other21"
									id="textarea9" rows="8"><s:property
											value="#rentcontract.other21" /></textarea> <span
								...
								id="sprytextarea10"> <textarea
									name="rentcontract.other51" id="textarea10" cols="45" rows="8"><s:property
											value="#rentcontract.other51" /></textarea> <span
