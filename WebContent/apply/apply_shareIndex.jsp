			...
			<div id="navi">
				<div>
					<table class="tablenoborder" border="0" cellpadding="0"
						...
						<tr>
							<td><label><a
									href="../apply/Apply!newApply_share_agreement">新建<b>【协议流转】</b>入股申请
								</a></label></td>
							<td><label><a
									href="../apply/Apply!newApply_share_bid">新建<b>【委托交易】</b>入股申请
								</a></label></td>
							<td><label></label></td>
							<td><label><a
									href="../apply/Apply!listtoSubmitApply_share"><b>查看【待提交】</b>入股申请
								</a></label></td>
							<td><label><a
									href="../apply/Apply!listSubmitedApply_share">查看<b>【已提交】</b>入股申请状态
								</a></label></td>
						</tr>
					</table>
				</div>
