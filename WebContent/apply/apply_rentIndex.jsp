			...
			<div id="navi">
				<table width="100%" border="0" class="navitable" cellspacing="0"
					...
					<tr>
						<td >
							<div id="naviItem">
								<a href="../apply/Apply!newApply_rent_agreement">新建<b>【协议流转】</b>出租申请
								</a>
							</div>
							<div id="naviItem">
								<a href="../apply/Apply!newApply_rent_bid">新建<b>【委托交易】</b>出租申请
								</a>
							</div>
							<div id="naviItem">
								<a href="../apply/Apply!listtoSubmitApply_rent"><b>查看【待提交】</b>出租申请
								</a>
							</div>
							<div id="naviItem">
								<a href="../apply/Apply!listSubmitedApply_rent">查看<b>【已提交】</b>出租申请状态
								</a>
							</div>
						</td>
					</tr>
