		...
		<div id="wrap">
			...
			<div id="client">
				<div id="rightCheck">
							...
							<table width="100%" border="0" cellpadding="0" cellspacing="0"
								...
								<tr class="right">
									...
									<td><span id="sprytextfield1"> <input
											...
											id="rightWarrant" size="20" maxlength="20" value="${Apply.landVillage}" /> <span
											...
											class="textfieldMaxCharsMsg">超过20位。</span></span><s:property value="#Apply.landVillage"/></td>
								</tr>
								<tr class="right hide">
									...
									<td><span id="sprytextfield2"> <input
											...
											disabled="disabled" value="${Apply.landVillage}"/> <span class="textfieldRequiredMsg">必填，20位（年份4位+县级代码6位+乡镇代码2位+村代码2位+组社代码2位+顺序码4位）。</span><span
											class="textfieldMinCharsMsg">不足20位。</span><span
											class="textfieldMaxCharsMsg">超过20位。</span></span><s:property value="#Apply.landVillage"/></td>
								</tr>
								<tr>
									<td></td>
									<td><input type="submit" id="btnSubmit3" value="保存" />修改类型</td>
								</tr>
							</table>
						</form>
					</div>
					test#Apply.landwarrantCode:<s:property value="#Apply.landwarrantCode" />
					...
					test#Apply.landcontractCode:<s:property value="#Apply.landcontractCode" />
					<s:if test="#Apply.landcontractCode!=null">
						<s:if test="#Apply.rightAuthType==2">
							<div id="div1">
								...
								<s:url action="Apply!viewLandContract" var="urlViewLandContract">
									<s:param name="apply.id" value="#Apply.id" />
								</s:url>
