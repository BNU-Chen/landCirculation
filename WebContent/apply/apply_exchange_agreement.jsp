			...
			<table border="0" align="left" cellpadding="0" cellspacing="0">
				<tr>
					<td><label class="selected" id="default"
						onclick="showTabpane(0)">甲方（申请方）信息</label></td>
					<td><label onclick="showTabpane(1)">乙方（互换方）信息</label></td>
					<td><label onclick="showTabpane(2)">流转土地基本情况</label></td>
					<td><label onclick="showTabpane(3)">权属证明信息</label></td>
					<td><label onclick="showTabpane(4)">互换协议详情</label></td>
				</tr>
			</table>
		</div>
		<div id="client">
